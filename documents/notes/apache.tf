...
#7. Create a network interface with an ip in the subnets that was create in step 4
...
resource "aws_instance" "web-server-instance" {
  ...
  network_interface {
    device_index = 0
    network_interface_id = ws_network_interface.web-server-nic.id
  }
